...
public class TuningController {
    public static double MOTOR_TICKS_PER_REV = 537.6; //not sure about this value
    public static double MOTOR_MAX_RPM = 340;
    public static double MOTOR_GEAR_RATIO = 18; // output (wheel) speed / input (motor) speed //19.2???

    public static double TESTING_MAX_SPEED = .9 * MOTOR_MAX_RPM; //.9
    public static double TESTING_MIN_SPEED = .3 * MOTOR_MAX_RPM; //.3
