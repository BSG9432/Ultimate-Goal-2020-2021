...
public class imuTeleTest extends OpMode {
    ...
    public double currentAngle; //get heading of IMU
    ...
    public void loop() {
       /* //telemetry to show output values for sticks (for testing purposes)
        ...
        //dragonbot.telemetry.addData("Right Wing", dragonbot.rightWing);
        dragonbot.telemetry.addData("Left Wing", dragonbot.wing);

        dragonbot.telemetry.update();
